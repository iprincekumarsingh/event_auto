      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full sm:w-2/3 lg:w-3/12 px-4">
          <div class="w-full mb-10">
            ...
            <p class="flex items-center text-sm text-dark font-medium">
              ...
              <span>+917389418444</span>

            </p>
            <span>support@divyasrishtievents.in</span>
          </div>
        </div>
        ...
        <div class="w-full sm:w-1/2 lg:w-2/12 px-4">
          <div class="w-full mb-10">
            ...
            <ul>
              <li>
                <a href="https://divyasrishtievents.in/terms-conditions" class="
                hover:underline
                       inline-block
              ...
              <li>
                <a href="https://divyasrishtievents.in/privacy-policy" class="
                hover:underline
                       inline-block
                       text-base text-body-color
                       hover:text-primary
              ...
              <li>
                <a href="https://divyasrishtievents.in/refund-cancellation" class="
                hover:underline
                       inline-block
                       text-base text-body-color
                       hover:text-primary
        ...
        <div class="w-full sm:w-1/2 lg:w-3/12 px-4">
          <div class="w-full mb-10">
            ...
            <div class="flex items-center mb-6">
                ...
                <a href="https://www.instagram.com/divyasrishti_events/"
                class="
  hover:underline
        w-8
        h-8
        ...
        xl:mr-4
        ">
                <img width="16" height="12" src="{{url('/img/ig.svg')}}" alt="" srcset="">
            </a>
            </div>
