@include('layout.header')
  ...
  <section class="bg-white py-20 lg:pb-[120px] overflow-hidden relative z-10 px-6">
      ...
      <div class="flex flex-wrap lg:justify-between -mx-4">
          ...
          <div class="max-w-[570px] mb-12 lg:mb-0">
            ...
            <div class="flex mb-8 max-w-[370px] w-full">
              ...
              <div class="w-full">
                ...
                <p class="text-base text-body-color">+917389418444</p>
              </div>
            </div>
            <div class="flex mb-8 max-w-[370px] w-full">
              <div class="
              ...
              <div class="w-full">
                ...
                <p class="text-base text-body-color">support@divyasrishtievents.in</p>
              </div>
            </div>
          </div>
        </div>
        <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
          <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
            <form action="/contactQuery" method="POST">
                @csrf
              <div class="mb-6">
                <input name="title" type="text" placeholder="Your Name" class="
                       w-full
                       rounded
                       py-3
                       px-[14px]
              ...
              <div class="mb-6">
                <input name="emailcontact" type="email" placeholder="Your Email" class="
                       w-full
                       rounded
                       py-3
                       px-[14px]
              ...
              <div class="mb-6">
                <input name="phoneCon" type="text" placeholder="Your Phone" class="
                       w-full
                       rounded
                       py-3
                       px-[14px]
              ...
              <div class="mb-6">
                <textarea name="query" rows="6" placeholder="Your Query" class="
                       w-full
                       rounded
                       py-3
                       px-[14px]
